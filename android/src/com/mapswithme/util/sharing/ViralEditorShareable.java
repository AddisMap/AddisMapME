...
{
  private static final String FACEBOOK_SHARE_URL = "http://me.addismap.com/fb-editor-v1?lang=" + Locale.getDefault().getLanguage();
  private static final String VIRAL_TAIL = " http://me.addismap.com/im_get";
